...
describe('appWithTranslation', () => {
  ...
  it('assures locale key is set to the right value', () => {
    ...
    const {
      rerender
    } = render( /*#__PURE__*/React.createElement(DummyApp, props));
    props.router.locale = 'en';
    props.pageProps._nextI18Next.initialLocale = 'en';
    rerender( /*#__PURE__*/React.createElement(DummyApp, props));
    rerender( /*#__PURE__*/React.createElement(DummyApp, props));
    rerender( /*#__PURE__*/React.createElement(DummyApp, props));
    props.router.locale = 'de';
    props.pageProps._nextI18Next.initialLocale = 'de';
    rerender( /*#__PURE__*/React.createElement(DummyApp, createProps('de')));
    const [[first], [second], [third], [fourth], [fifth]] = I18nextProvider.mock.calls;
