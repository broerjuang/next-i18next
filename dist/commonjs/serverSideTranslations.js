...
var serverSideTranslations = function serverSideTranslations() {
  var defaultConfigPath = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : DEFAULT_CONFIG_PATH;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 4:
              ...
              if (!(!userConfig && _fs["default"].existsSync(_path["default"].resolve(defaultConfigPath)))) {
                _context.next = 9;
                break;
              }

              _context.next = 8;
              return Promise.resolve("".concat(_path["default"].resolve(defaultConfigPath))).then(function (s) {
