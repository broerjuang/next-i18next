...
describe('appWithTranslation', function () {
  ...
  it('assures locale key is set to the right value', function () {
    ...
    var _render = (0, _react2.render)(__jsx(DummyApp, props)),
        rerender = _render.rerender;

    props.router.locale = 'en';
    props.pageProps._nextI18Next.initialLocale = 'en';
    rerender(__jsx(DummyApp, props));
    rerender(__jsx(DummyApp, props));
    rerender(__jsx(DummyApp, props));
    props.router.locale = 'de';
    props.pageProps._nextI18Next.initialLocale = 'de';
    rerender(__jsx(DummyApp, createProps('de')));

    var _mock$calls4 = (0, _slicedToArray2["default"])(_reactI18next.I18nextProvider.mock.calls, 5),
        _mock$calls4$ = (0, _slicedToArray2["default"])(_mock$calls4[0], 1),
        first = _mock$calls4$[0],
        _mock$calls4$2 = (0, _slicedToArray2["default"])(_mock$calls4[1], 1),
        second = _mock$calls4$2[0],
        _mock$calls4$3 = (0, _slicedToArray2["default"])(_mock$calls4[2], 1),
        third = _mock$calls4$3[0],
        _mock$calls4$4 = (0, _slicedToArray2["default"])(_mock$calls4[3], 1),
        fourth = _mock$calls4$4[0],
        _mock$calls4$5 = (0, _slicedToArray2["default"])(_mock$calls4[4], 1),
        fifth = _mock$calls4$5[0];
