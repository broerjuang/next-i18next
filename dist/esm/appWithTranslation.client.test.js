...
describe('appWithTranslation', function () {
  ...
  it('assures locale key is set to the right value', function () {
    ...
    var _render = render(__jsx(DummyApp, props)),
    ...
    var _mock$calls4 = _slicedToArray(I18nextProvider.mock.calls, 5),
        _mock$calls4$ = _slicedToArray(_mock$calls4[0], 1),
        first = _mock$calls4$[0],
        _mock$calls4$2 = _slicedToArray(_mock$calls4[1], 1),
        second = _mock$calls4$2[0],
        _mock$calls4$3 = _slicedToArray(_mock$calls4[2], 1),
        third = _mock$calls4$3[0],
        _mock$calls4$4 = _slicedToArray(_mock$calls4[3], 1),
        fourth = _mock$calls4$4[0],
        _mock$calls4$5 = _slicedToArray(_mock$calls4[4], 1),
